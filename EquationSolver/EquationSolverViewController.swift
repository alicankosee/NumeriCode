...
class EquationSolverViewController: BaseViewController {
    ...
    private func configureButtons() {
        let buttonConfigs: [(UIButton, String, String, Selector)] = [
            ...
            (simulationButton, "Simulation", "function", #selector(simulationTapped)),
